<?php
/**
 * This script uses a text file with the total page visits.
 * On each request we open the existing page visit count file.
 * We acquire an exclusive lock and increment the page visit count.
 * Finally we close the connection with the updated page visits.
