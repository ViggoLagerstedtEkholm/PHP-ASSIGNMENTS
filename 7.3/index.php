<?php
/**
 *  This script uses the FeedHandler to display all preconfigured RSS feeds.
 *  You can modify both the RSS URL and the "Display limit", this limit will define the amount of items in the feed to display.
 *  You can delete saved feeds.
 *  See the "database" folder for the database.
